...
## Note: this branch is designed to support legacy versions of Python and isn't officially supported. I will try to keep this up to date and maximize compatibility but I can't promise long-term support. Currently, it supports Python versions >= 3.7.0, although that is subject to change at any time. No warranty, I'm not liable, etc
